...
datetime_with_option_seconds = r'^(\d\d\d\d-(0?[1-9]|1[0-2])-(0?[1-9]|[12][0-9]|3[01]) (0[0-9]|1[0-9]|2[0-3]):([0-5][0-9]){0,1}(:[0-5][0-9]){0,1})$'
...
legacy_query.add_argument('organisationsnummer', type=str)
